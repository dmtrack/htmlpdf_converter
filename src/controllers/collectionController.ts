...
export const getUserCollections: RequestHandler = async (req, res) => {
...
export const getOneCollection: RequestHandler = async (req, res) => {
...
export const deleteOneCollection: RequestHandler = async (req, res) => {
    const id = req.params.id
...
export const editCollection: RequestHandler = async (req, res) => {
    const { collection, itemConfigs } = req.body
    const response = await CollectionService.edit(collection, itemConfigs)
